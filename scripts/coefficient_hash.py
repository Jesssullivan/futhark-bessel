...
sources = [
    ...
    Path("oracle/solver_root_envelopes.c"),
    ...
    Path("scripts/solver_root_manifest.py"),
    Path("scripts/solver_root_envelope_proof.py"),
    Path("scripts/test_solver_root_envelope_fail_closed.py"),
    ...
    Path("evidence/solver-root-envelopes.json"),
